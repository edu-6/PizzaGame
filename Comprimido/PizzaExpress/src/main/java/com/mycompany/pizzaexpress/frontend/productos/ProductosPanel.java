...
public class ProductosPanel extends javax.swing.JPanel {
     ...
     *
     */
    public ProductosPanel(TenderoBase padre) {
        this.padre = padre;
        initComponents();
    ...
    public void mostrarProductoForm(Producto producto) {
        this.formularioPanel.removeAll();
        this.formularioPanel.setLayout(new BorderLayout());
        this.formularioPanel.add(new NuevoProductoPanel(this.formularioPanel, producto, this), BorderLayout.NORTH);
    ...
    private void buscarPorString(){
        ...
        try {
            Producto Producto = crudService.buscarProductoEnSucursal(this.barraBusqeuda.getText(), Sesion.getUsuario().getIdSucursal());
    ...
    private void buscarTodos(){
        ...
        try {
            // Buscar todos los productos de la sucursal
            ArrayList<Producto> lista = this.crudService.buscarConUnParametroInt(Sesion.getUsuario().getIdSucursal());
            this.mostrarResultados(lista);
        } catch (ExceptionGenerica ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    ...
    private void mostrarResultados(ArrayList<Producto> lista){
        this.panelResultados.removeAll();
        ...
        JPanel contenedor = new JPanel();
            ...
            for (Producto Producto : lista) {
                ProductoInfo tarjeta = new ProductoInfo(Producto, contenedor, this);
    ...
    private void initComponents() {
        ...
        panelResultados.setBackground(new java.awt.Color(255, 204, 51));
        ...
        nuevaBtn.setText("Nuevo producto");
    ...
    private void nuevaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevaBtnActionPerformed
        this.formularioPanel.removeAll();
        this.formularioPanel.setLayout(new BorderLayout());
        this.formularioPanel.add(new NuevoProductoPanel(this.formularioPanel, this), BorderLayout.NORTH);
        this.formularioPanel.revalidate();
        this.formularioPanel.repaint();
        this.revalidate();
        this.repaint();
